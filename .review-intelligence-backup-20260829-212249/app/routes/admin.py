...
from ..services.candidate_extract import extract_candidate_prefill
...
from ..services.source_images import discover_public_post_image, download_public_source_image, is_allowed_public_image_url
...
async def discovery_to_submission(request: Request, candidate_id: int):
    ...
    with SessionLocal() as db:
        ...
        notes_parts = [candidate.snippet or ""]
        if ocr_text:
