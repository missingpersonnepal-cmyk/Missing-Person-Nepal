...
from .priority_sources import priority_source_scopes, priority_wide_queries
...
def generate_wide_queries(
    ...
    priority_queries = priority_wide_queries(disaster)
    ...
    combined_scopes = _unique([*(source_scopes or []), *seeded_scopes])
    ...
    # Priority source seeds receive a guaranteed lane, while location results
